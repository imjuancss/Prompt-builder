...
export const PRESET_TYPOGRAPHY: TypographyPair[] = [
  ...
  {
    id: "typo-geist-inter",
    name: "Geist + Inter (Vercel & Minimal Dev)",
    headingFont: "Geist",
    bodyFont: "Inter",
    styleNote: "Inspirado en la estética minimalista de Vercel y Next.js. Precisión geométrica de alta fidelidad.",
  },
  {
    id: "typo-geist-mono",
    name: "Geist + Geist Mono (Technical & Code Native)",
    headingFont: "Geist",
    bodyFont: "Geist Mono",
    styleNote: "Estética monospaciada e hiper-técnica ideal para documentación, APIs, terminales y herramientas SaaS dev-first.",
  },
  {
    id: "typo-bricolage-jakarta",
    name: "Bricolage Grotesque + Plus Jakarta Sans (Trendy Neo-Grotesque)",
    headingFont: "Bricolage Grotesque",
    bodyFont: "Plus Jakarta Sans",
    styleNote: "Tipografía expresiva, dinámica y con personalidad audaz para landings SaaS de última generación.",
  },
  {
    id: "typo-instrument-inter",
    name: "Instrument Serif + Inter (Editorial Luxury & SaaS)",
    headingFont: "Instrument Serif",
    bodyFont: "Inter",
    styleNote: "Elegancia serif contemporánea combinada con la máxima legibilidad de Inter para marcas de lujo y startups.",
  },
  {
    id: "typo-sora-manrope",
    name: "Sora + Manrope (Fintech & AI Next-Gen)",
    headingFont: "Sora",
    bodyFont: "Manrope",
    styleNote: "Diseñado para pantallas digitales de alta resolución. Sólido y amigable para fintechs, crypto y productos AI.",
  },
  {
    id: "typo-urbanist-dm",
    name: "Urbanist + DM Sans (Clean Geometric Architecture)",
    headingFont: "Urbanist",
    bodyFont: "DM Sans",
    styleNote: "Líneas geométricas impecables con espaciado amplio. Excelente para productos de arquitectura, diseño e inmobiliarias.",
  },
  {
    id: "typo-poppins-jakarta",
    name: "Poppins + Plus Jakarta Sans (Consumer & Community)",
    headingFont: "Poppins",
    bodyFont: "Plus Jakarta Sans",
    styleNote: "Cálido, accesible y altamente confiable para e-commerce, apps móviles y plataformas comunitarias.",
  },
  {
    id: "typo-cabinet-inter",
    name: "Cabinet Grotesk + Inter (Design System Native)",
    headingFont: "Cabinet Grotesk",
    bodyFont: "Inter",
    styleNote: "Estilo neo-grotesco distintivo para agencias de branding, productos digitales de autor y estudios de diseño.",
  },
  {
  ...
  {
    id: "typo-lexend-open",
    name: "Lexend + Open Sans (Maximum Legibility & Focus)",
    headingFont: "Lexend",
    bodyFont: "Open Sans",
    styleNote: "Optimizada científicamente para reducir la fatiga visual y acelerar la velocidad de lectura del usuario.",
  },
  {
    id: "typo-bricolage-spacemono",
    name: "Bricolage Grotesque + Space Mono (Disruptive Web3 & Cyber)",
    headingFont: "Bricolage Grotesque",
    bodyFont: "Space Mono",
    styleNote: "Combinación provocadora e impactante para plataformas de blockchain, gaming y eventos de tecnología.",
  },
  {
...
export const GOOGLE_FONTS_COLLECTION: GoogleFontOption[] = [
  { family: "Geist", category: "sans-serif", description: "Tipografía ultramoderna de Vercel con geometría limpia y densidad óptima para UI." },
  { family: "Geist Mono", category: "monospace", description: "Versión monospaciada técnica de Geist ideal para código, datos y terminales." },
  { family: "Bricolage Grotesque", category: "sans-serif", description: "Neo-grotesca expresiva con giros inesperados y gran personalidad visual." },
  { family: "Instrument Serif", category: "serif", description: "Serif de alta elegancia inspirada en publicaciones de diseño y moda contemporánea." },
  ...
  { family: "Sora", category: "sans-serif", description: "Diseñada para pantallas digitales, interfaces financieras y startups." },
  { family: "Manrope", category: "sans-serif", description: "Geométrica semi-condensada con proporciones abiertas altamente legibles." },
  { family: "Urbanist", category: "sans-serif", description: "Inspirada en el diseño urbano moderno, limpia y sofisticada." },
  { family: "Poppins", category: "sans-serif", description: "Geométrica redondeada, amable y de alta presencia visual." },
  { family: "Lexend", category: "sans-serif", description: "Optimizada científicamente para mejorar la fluidez de lectura." },
  ...
  { family: "Space Mono", category: "monospace", description: "Monospaciada estilizada con vibra ciberpunk y técnica." },
